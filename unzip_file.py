...
source_folder = r"C:\Repos\GitHub\GetOfficeKBs\Office2013_KBs\x64"
target_folder = r"C:\Repos\GitHub\GetOfficeKBs\Office2013_KBs\x64_msp"
temp_folder = r"C:\Repos\GitHub\GetOfficeKBs\Office2013_KBs\temp"
...
for root, dirs, files in os.walk(source_folder):
    for name in files:
        if name.endswith("cab"):
            ...
            target_file_name = name[:-4] + "_" + root[-3:] + ".msp"
